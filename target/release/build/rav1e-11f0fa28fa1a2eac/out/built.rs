...
#[allow(dead_code)]
pub static RUSTC: &str = "C:\\Users\\32234\\.rustup\\toolchains\\stable-x86_64-pc-windows-gnu\\bin\\rustc.exe";
#[doc=r#"The documentation generator that cargo resolved to use."#]
#[allow(dead_code)]
pub static RUSTDOC: &str = "C:\\Users\\32234\\.rustup\\toolchains\\stable-x86_64-pc-windows-gnu\\bin\\rustdoc.exe";
...
#[doc=r#"The output of `C:\Users\32234\.rustup\toolchains\stable-x86_64-pc-windows-gnu\bin\rustc.exe -V`"#]
#[allow(dead_code)]
pub static RUSTC_VERSION: &str = "rustc 1.88.0 (6b00bc388 2025-06-23)";
#[doc=r#"The output of `C:\Users\32234\.rustup\toolchains\stable-x86_64-pc-windows-gnu\bin\rustdoc.exe -V`; empty string if `C:\Users\32234\.rustup\toolchains\stable-x86_64-pc-windows-gnu\bin\rustdoc.exe -V` failed to execute"#]
#[allow(dead_code)]
